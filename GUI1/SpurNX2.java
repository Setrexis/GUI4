 ...
 * 
 */
public class SpurNX2 implements IComponente {
	public static int maxanzahlPunkte = 10000;
	
	private CSpurNX2 obj;
	int anzahl = 4;
	 ...
	 * @param neueHoehe
	 */
	public SpurNX2(int anzahl, int neueBreite, int neueHoehe) {
	 ...
	 * @param neueHoehe
	 */
	public SpurNX2(int anzahl, int neuesX, int neuesY, int neueBreite,
			int neueHoehe) {
	 ...
	 * @param behaelter
	 */
	public SpurNX2(IContainer behaelter, int anzahl) {
	 ...
	 * @param neueHoehe
	 */
	public SpurNX2(IContainer behaelter, int anzahl, int neuesX, int neuesY,
			int neueBreite, int neueHoehe) {
		this.anzahl = anzahl;
		obj = new CSpurNX2(anzahl);
		behaelter.add(obj, 0);
...
class CSpurNX2 extends BasisComponente {
	int anzahl = 20;
	Vector<Point>[] spuren;
	Color[] farben;
	int[] durchmesser;
	...
	public void addPoint(int nrSpur, int x, int y) {
		...
		if (spuren[nrSpur].size() >= SpurNX2.maxanzahlPunkte ) {
