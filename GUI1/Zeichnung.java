...
public class Zeichnung extends JFrame {
    ...
    public void hintergrundFarbe(Color farbe){
       Zeichnung.gibZeichenflaeche().setBackground(farbe);
    }
...
abstract class BasisComponente extends JPanel {
    ...
    protected float fontGroesse = 20;
    ...
    protected void zoomen() {
        ...
        fontGroesse = (float) Math
                .round(originalFontGroesse * zoomFaktor * bzf);
    }
    ...
    public void setzeBasisfarbe(Color farbname) {
        farbe = farbname;
        repaint();
    }
