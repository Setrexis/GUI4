...
public class Carambolage_Aktion_Schwerpunkt implements ITuWas {
	...
	public Carambolage_Aktion_Schwerpunkt() {
		...
		sb_1 = new Schieberegler('H', 0, 200, 200, 30, 5, 60, 20);
		sb_1.setzeFarbe("rot");
		...
		sb_2 = new Schieberegler('H', 0, 230, 200, 30, 5, 60, 10);
		...
		ball_Schwerpunkt.setzeFarbe("scharz");
		berechneSchwerpunkt();
		ball_Schwerpunkt.setzeMittelpunkt(sx, sy);
		takt = new Taktgeber();
		takt.setzteAnfangsZeitverzoegerung(100);
		takt.setzteZeitZwischenAktionen(50);
		takt.setzeLink(this, 0);
		takt.endlos();
		
		richtung = new Taste("", 170, 0, 30, 30);
