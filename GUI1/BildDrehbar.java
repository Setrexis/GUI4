...
public class BildDrehbar implements IComponente {
	private CBildDrehbar obj;
	 ...
	 * @param filename
	 */
	public BildDrehbar(String filename) {
	 ...
	 * @param datei
	 */
	public BildDrehbar(BilddateiAbstrakt datei) {
	 ...
	 * @param filename
	 */
	public BildDrehbar(int neueBreite, int neueHoehe, String filename) {
	 ...
	 * @param datei
	 */
	public BildDrehbar(int neueBreite, int neueHoehe, BilddateiAbstrakt datei) {
	 ...
	 * @param filename
	 */
	public BildDrehbar(int neuesX, int neuesY, int neueBreite, int neueHoehe,
			String filename) {
	 ...
	 * @param filename
	 */
	public BildDrehbar(IContainer behaelter, String filename) {
	 ...
	 * @param datei
	 */
	public BildDrehbar(IContainer behaelter, BilddateiAbstrakt datei) {
	 ...
	 * @param filename
	 */
	public BildDrehbar(IContainer behaelter, int neuesX, int neuesY, int neueBreite,
			int neueHoehe, String filename) {
		bild = setzeBilddatei(filename);
		obj = new CBildDrehbar(bild);
		behaelter.add(obj, 0);
		breite = neueBreite;
		hoehe = neueHoehe;
	...
	public double getWinkel() {
		return obj.getWinkel();
	}

	public void setWinkel(double winkel) {
		 obj.setWinkel(winkel);
	}
...
class CBildDrehbar extends BasisComponente {
	private BufferedImage bild;
	private Image bildM;
	 ...
	 */
	public CBildDrehbar(BufferedImage bild) {
		this.bild = bild;
		this.bildM = bild;
	}
	...
	public void paintComponentSpezial(Graphics g) {
		...
		g2.rotate( winkel , breite/2, hoehe/2);
