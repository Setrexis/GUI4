...
public class BehaelterTablayout extends BasisComponente implements IContainer,
	 ...
	 * 
	 * @param tabText Tab-Beschreibung
	 * @param inhalt Zeichenflaeche
	 */
	 ...
	 * 
	 * @param index Nummer des Tabs (Beginn 0)
	...
	public Zeichenflaeche getZeichenflaeche(int index){
		if ((parentPane.getTabCount() > 0)&&(parentPane.getTabCount()>index)){
