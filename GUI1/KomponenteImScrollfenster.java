...
public class KomponenteImScrollfenster implements IComponente {
	 ...
	 * @param neueHoehe
	 */
	public KomponenteImScrollfenster(IComponente innen, int neueBreite,
			int neueHoehe) {
	 ...
	 * @param neueHoehe
	 */
	public KomponenteImScrollfenster(IComponente innen, int neuesX, int neuesY,
			int neueBreite, int neueHoehe) {
		this(Zeichnung.gibZeichenflaeche(), innen, neuesX, neuesY, neueBreite,
				neueHoehe);
	}
