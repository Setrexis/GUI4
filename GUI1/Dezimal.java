 ...
 * <br/>
 * 
 * istGleich , istGroesser , istKleiner , </br> istGleichNull, istGroesserNull ,
 * istKleinerNull , </br><br/>
 * 
...
public class Dezimal {
	...
	/**
	 * Erzeugt die Dezimalzahl NotANumber Wird als Basis fuer Rueckgabe verwendet
	 * 
	 * @param NaN
	 */
	...
	public Dezimal(long[] zahl) {
		try {
			dezimalzahl = (BigDecimal.valueOf(zahl[0]))
					.movePointRight((int) zahl[1]);
		} catch (Exception e) {
			NotANumber = true;
		}
	...
	public long toLong() {
		...
		BigDecimal erg = dezimalzahl.round(new MathContext(0,
				RoundingMode.HALF_EVEN));
	...
	public void setzeNachkommastellen(int nachkommastellen) {
		dezimalzahl = dezimalzahl.setScale(nachkommastellen,
