 ...
 */
public class Rollbalken implements IComponente {
	
	private CRollbalken	obj;
	 ...
	 * @param neueHoehe
	 */
	public Rollbalken(char ausrichtung, int neueBreite, int neueHoehe) {
	 ...
	 * @param neueHoehe
	 */
	public Rollbalken(char ausrichtung, int neuesX, int neuesY, int neueBreite,
			int neueHoehe) {
	 ...
	 */
	public Rollbalken(char ausrichtung, int neuesX, int neuesY, int neueBreite,
			int neueHoehe, double min, double max, double wert) {
		this(Zeichnung.gibZeichenflaeche(), ausrichtung, neuesX, neuesY,
	 ...
	 *            horizontal 'H' oder senkrecht 'S'
	 */
	public Rollbalken(IContainer behaelter, char ausrichtung) {
	 ...
	 * @param neueHoehe
	 */
	public Rollbalken(IContainer behaelter, char ausrichtung, int neuesX,
	...
	public Rollbalken(IContainer behaelter, char ausrichtung, int neuesX,
			...
			double wert) {
		obj = new CRollbalken(ausrichtung);
...
class CRollbalken extends BasisComponente implements AdjustmentListener {
	 ...
	 */
	public CRollbalken(char ausrichtung) {
		this.setLayout(new BorderLayout());
		if (ausrichtung == 'H') {
			balken = new JScrollBar(Adjustable.HORIZONTAL, teilung / 2,
					teilung / 10, 0, teilung * 11 / 10);
			
		} else {
			balken = new JScrollBar(Adjustable.VERTICAL, teilung / 2,
					teilung / 10, 0, teilung * 11 / 10);
		}
		balken.setBlockIncrement(20);
		balken.setUnitIncrement(1);
