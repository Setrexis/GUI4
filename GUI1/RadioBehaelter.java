 ...
 * <a href="RadioTaste.html">Siehe Klasse Radiotaste</a> <br/><br/>
 *  
 ...
 * <h2>Anwendung:</h2>
 * <ul>
 *    <li> Radiobehaelter erzeugen: radiobehaelter = new RadioBehaelter(0,152,200,47);</li>
 *    <li> RadioTaste in den Behaelter setzen: r1 = new RadioTaste(radiobehaelter, "ro", 7, 15, 60, 30);</li>
 *    <li> ID der Taste setzen: r1.setzeID(3);</li>
 *    <li> Anfangs gesetzte Taste festlegen: r1.setzeGewaehlt(); </li>
 *    <li> Optional: Kommunikations-Link vom Radiobehaelter auf ein anderes Ziel setzen. 
 *    Es wird dann statt dem Radiobehaelter das andere Objekt informiert. 
