 ...
 * 
 * <hr>
 *  <b>Bekannten Farbnamen</b> sind in der Methode leseBekannteFarben angegeben.<br/>
 * Diese Farbnamen k&ouml;nnen erg&auml;nzt werden. Die Farbe braun ist dafuer ein Muster.   
 *<hr>
 * @author Hans Witt
 * @version
 * Version: 1.2 (19.7.2008)
 *        Uebersetzung NOSW in ENUM Richtung NOSW <br />
 * Version: 1.3 (12.12.2008)
 *        gibZufall(int zahl) verbessert<br />
 * Version: 1.4 (21.09.2010)
 *        Fehler bei Richtung behoben<br />
 *        
 * Version: 2 (1.1.2011) Farbmanagement ge&auml;ndert.<br/>
 * Es sind jetzt Farben mit beliebigem Namen moeglich. <br />
 * Gibt es eine Farbe nicht, so wird der Farbdialog aufgerufen un die Farbe definiert.<br/>
 * Link zu einer Farbtabelle: http://www.uni-magdeburg.de/counter/rgb.txt.shtml (6.1.2011)<br/>
 * 
 * 
 */
public class StaticTools {
	 ...
	 */
	public static void setUnbekannteFarbeNachfragen(
			boolean unbekannteFarbeNachfragen) {
	...
	public static Color getColor(String farbname) {
		...
		if (tColor != null) {
			...
			if (unbekannteFarbeNachfragen) {
				Color cErgebnis = JColorChooser.showDialog(
						Zeichnung.gibZeichenflaeche(), "Farbe " + farbname
								+ " aussuchen", tColor);
				if (cErgebnis != null)
					tColor = cErgebnis;
				setzeFarbe(farbname, tColor);
	 ...
	 * 
	 * @param farbname
	 * @param rgb  String der Form "100,200,6"
	 */
	public static void setzeFarbe(String farbname, String rgb) {
		if((farbname==null)||(rgb==null)) return ;
		int r = 0;
		int g = 0;
		int b = 0;
	...
	public static long jetzt() {
		...
		zeit = cal.get(Calendar.SECOND) + (60 * cal.get(Calendar.MINUTE))
...
class Farben {
	...
	public Vector<String[]> leseFarben() {
		...
		for (Farbe farbe : farben) {
			...
			txtFarbe[1] = "" + farbe.getFarbe().getRed() + ","
					+ farbe.getFarbe().getGreen() + ","
